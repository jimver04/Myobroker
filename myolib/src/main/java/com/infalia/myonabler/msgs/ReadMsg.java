...
public class ReadMsg extends MyoMsg {
    ...
    /**
     * {@link com.infalia.myonabler.BaseMyo} will use this method to set the value after the bluetooth transmission returned with {@link android.bluetooth.BluetoothGatt#GATT_SUCCESS}
