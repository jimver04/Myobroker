...
import com.infalia.myonabler.services.MyoService;

/**
 * The base class for all communication done with a Myo.
 * Intended to be used with {@link com.infalia.myonabler.BaseMyo#submit(MyoMsg)}.
 * <br>
...
public class MyoMsg {
    ...
    public enum State {
        /**
         * Message has not been submitted yet via {@link com.infalia.myonabler.BaseMyo#submit(MyoMsg)}.
         */
        NEW,
        /**
    ...
    /**
     * See <br>
     * {@link com.infalia.myonabler.services.Battery}<br>
     * {@link com.infalia.myonabler.services.Classifier}<br>
     * {@link com.infalia.myonabler.services.Control}<br>
     * {@link com.infalia.myonabler.services.Device}<br>
     * {@link com.infalia.myonabler.services.Emg}<br>
     * {@link com.infalia.myonabler.services.Generic}<br>
     * {@link com.infalia.myonabler.services.Imu}<br>
     * <p>
     *
    ...
    /**
     * This will be used by {@link com.infalia.myonabler.BaseMyo}. Don't call it yourself.
     *
     */
    ...
    /**
     * Set by {@link com.infalia.myonabler.BaseMyo} after a message is send, shortly before the callback is triggered.
